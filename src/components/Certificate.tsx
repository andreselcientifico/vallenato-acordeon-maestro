  ...
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div
        ...
        className="p-8 bg-gradient-to-br from-amber-50 to-orange-50 print:bg-white"
      >
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-4 w-full py-8">
            <p className="text-gray-700 text-sm">Se certifica que</p>
            ...
            <p className="text-gray-700">ha completado exitosamente el curso</p>
  ...
  if (certificates.length === 0) {
    return (
      <Card className="p-12 text-center bg-gray-50">
        ...
        <p className="text-lg text-gray-600">No tienes certificados aún</p>
        <p className="text-sm text-gray-500 mt-2">
          Completa y aprueba los quizzes de los cursos para desbloquear
          certificados
        </p>
      </Card>
    );
